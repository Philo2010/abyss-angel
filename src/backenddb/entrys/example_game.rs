...
use crate::{backenddb::{entrys::example_game, game::{self, AvgReturn, GamesAvgSpecific, GamesEditSpecific, GamesFullSpecific, GamesInsertsSpecific, InsertReturn, TeamGameUnMergedData, YearOp}}, entity::genertic_header};
...
fn get_auto_score(hehe: i32, _beep: i32) -> i32 {
    hehe * 6
}

fn get_teleop_score(_hehe: i32, beep: i32) -> i32 {
    beep * 7
}
